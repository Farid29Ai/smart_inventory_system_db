    ...
    <div class="admin-form-header">
        <div>
            <nav class="admin-form-breadcrumb" aria-label="breadcrumb">
                ...
                <span>/</span>
                <strong><?= __('Add Requisition Item') ?></strong>
            </nav>
            <div class="admin-form-title-row">
                <span class="admin-form-title-icon"><i class="bi bi-list-check"></i></span>
                <div>
                    <h1><?= __('Add Requisition Item') ?></h1>
                    <p><?= __('Attach requested inventory items to a requisition.') ?></p>
                </div>
            </div>
        </div>
    ...
    <div class="admin-form-card requisition-item-form-card">
        <?= $this->Form->create($requisitionItemEntity, ['class' => 'admin-modern-form']) ?>
            ...
            <div class="admin-form-actions">
                ...
                <?= $this->Form->button('<i class="bi bi-check2-circle"></i> ' . __('Create Requisition Item'), ['class' => 'admin-form-submit', 'escapeTitle' => false]) ?>
            </div>
        <?= $this->Form->end() ?>
    </div>
</section>
